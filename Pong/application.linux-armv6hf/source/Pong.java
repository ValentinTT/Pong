...
public void setup() {
  ...
  Control = new Serial(this, Serial.list()[0], 9600);
  Control.bufferUntil(',');
...
public void serialEvent (Serial Control) { //Cada vez que arduino envia un dato.
...
public void mousePressed() {//Al hacer click se cambia el valor de juego, para entrar o no al bucle while().
  textSize(30);
